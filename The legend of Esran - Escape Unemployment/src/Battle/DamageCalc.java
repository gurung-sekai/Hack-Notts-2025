...
public class DamageCalc {
    public static class Result {
        public final int damage; public final double mult; public final boolean crit;
        public Result(int damage, double mult, boolean crit) {this.damage=damage;this.mult=mult;this.crit=crit;}
    }

    public static Result compute (Fighter atk, Fighter def, Technique_t, int momentum) {
